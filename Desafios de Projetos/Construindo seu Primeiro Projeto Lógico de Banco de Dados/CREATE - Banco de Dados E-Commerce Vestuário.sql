...
create table produto (
    ...
    Tipo ENUM('VESTUÁRIO', 'CALÇADOS', 'ACESSÓRIOS') not null,
...
Endereço_Completo VARCHAR(120) not null
);
...
create table entrega (
    ...
    Status_entrega ENUM('EM TRANSITO', 'ENTREGUE', 'DEVOLVIDO') default 'EM TRANSITO',
